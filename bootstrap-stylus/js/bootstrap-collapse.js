...
!function($) {
    ...
    Collapse.prototype = {
        ...
        constructor: Collapse, dimension: function() {
            ...
            var that = this
                    , transitioning = false //need another local "transitioning" to avoid race condition
                    , complete = function() {
                        if (that.transitioning && transitioning) {
            ...
            if ($.support.transition && this.$element.hasClass('collapse')) {
                ...
                // timeout is equal to transition time from component-animations.styl
