...
function expressWrapper(options) {
    ...
    var app = express();
    var staticDirs = [pubDir, fontAwesomeDir];
    ...
    app.configure(function() {
        ...
        _.each(staticDirs, function(staticDri) {
            app.use(staticUrlPrefix, express.static(staticDri, {maxAge: 0}));
            //https://developers.google.com/speed/docs/best-practices/caching
            app.use(foreverUrlPrefix, express.static(staticDri, {maxAge: oneYearCache}));
        });
        app.use(app.router);
    });
